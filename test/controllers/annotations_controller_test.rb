...
class AnnotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create annotation" do
    assert_difference('Annotation.count') do
      post annotations_url, params: { annotation: { comment: @annotation.comment, times: @annotation.times, tutorial_id: @annotation.tutorial_id, user_id: @annotation.user_id } }
    end
  ...
  test "should update annotation" do
    patch annotation_url(@annotation), params: { annotation: { comment: @annotation.comment, times: @annotation.times, tutorial_id: @annotation.tutorial_id, user_id: @annotation.user_id } }
