...
class CareersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post careers_url, params: { career: { code: @career.code, department_id: @career.department_id, name: @career.name } }
    end
  ...
  test "should update career" do
    patch career_url(@career), params: { career: { code: @career.code, department_id: @career.department_id, name: @career.name } }
